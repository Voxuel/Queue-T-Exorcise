...
namespace ExcerciseQueue221102
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var p2 = new Patient("Sara", "Female", 13244, "2012-01-07", "Scurvy", true,false,"2013-11-13");
            var p3 = new Patient("Bob", "Male", 15332, "2012-10-31", "Ligma", true,false,"2012-11-01");
            var p4 = new Patient("Sandra", "Female", 199329, "2012-06-08", "The heelees", true,true,"2012-07-07");
